...
import BackupRestoreDialog from "@/components/forms/BackupRestoreDialog";
    ...
    <div>
      <div className="page-header">
        ...
        <div className="flex gap-2">
          <Button variant="outline" size="sm" className="gap-1.5" onClick={() => setRestoreDialog(true)}>
      ...
      <BackupRestoreDialog open={restoreDialog} onOpenChange={setRestoreDialog} />
    </div>
  );
};
